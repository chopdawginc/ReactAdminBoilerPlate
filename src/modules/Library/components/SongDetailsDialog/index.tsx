...
import { Song, User } from 'collections/schema'
import {
  Dialog,
  DialogContent,
  Button,
...
const SongDetailsDialog: FC<SongDetailsDialogProps> = ({
  open,
  onClose,
  data,
}) => {
  ...
  const provider = getProviders.data?.find(
