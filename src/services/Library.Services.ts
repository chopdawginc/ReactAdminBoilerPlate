...
import { Admin, AppContent, Provider, Song } from 'collections/schema'
import {
  getDocumentById,
...
import { ESongStatus } from 'collections/types'
                ...
                try {
                  ...
                  const songRef = await addDoc(
                    collection(firestore, COLLECTIONS.SONGS),
                    {
                      ...
                      createdBy: getDocumentReference(
                        COLLECTIONS.ADMINS,
                        userId
                      ),
                      timesPlayed: 0,
                  ...
                  await updateDoc(
                    doc(firestore, COLLECTIONS.SONGS, songRef.id),
                    {
                      id: songRef.id,
                    }
                  )
