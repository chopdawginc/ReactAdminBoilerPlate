...
import { User } from 'collections/schema'
import ResetEmailAndPassword from '../ResetEmailAndPassword/ResetEmailAndPassword'
      ...
      <DialogContent>
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography>
              <strong>What do you want to get out of this app?</strong>
            </Typography>
